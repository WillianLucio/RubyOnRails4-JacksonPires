class KindsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @kind.save
        format.html { redirect_to kinds_path, notice: t("messages.created") }
  ...
  def update
    respond_to do |format|
      if @kind.update(kind_params)
        format.html { redirect_to kinds_path, notice: t("messages.updated") }
  ...
  def destroy
    @kind.destroy
    respond_to do |format|
      format.html { redirect_to kinds_url, notice: t("messages.desctroyed") }
